...
<div class="container" id="div1">
    <section> <!-- sumbmenue titles and style -->
        <div class="row container ml-2 mt-3 mb-3">
            <div class="p-1">
                <button class="btn btn-outline-success fixedsize p-1" id="btn1"> Babies </button></div>
            <div class="p-1">
                <button class="btn btn-outline-success fixedsize p-1" id="btn2"> Toddlers</button></div>
            <div class="p-1">
                <button class="btn btn-outline-success fixedsize p-1" id="btn3"> Preschoolers</button></div>
            <div class="p-1">
                <button class="btn btn-outline-success fixedsize p-1" id="btn4"> Family Class</button></div>
            <div class="p-1">
    ...
    <section>
        <div class="container "> <!-- class info -->
            <div class="col-sm" style="background-color: #CCE8E0">
                <div class="row">
                    <div class="col-sm" id="left-col">  <!-- text for classes -->
                    ...
                    <div class="col-sm mb-4" id="right-col">  <!-- Image for classes -->
...
<!-- Change text and images sor submenu items -->

    <script>
        $(document).ready(function(){
            $("#btn1").click(function(){
                // Change image for Babies on click of btn1(Baby)
                $("#specify_image").attr("src", "img/cls2.jpg");
                // Change text for Babies on click of btn1(Baby)
            ...
            $("#btn2").click(function(){
                // Change image for Toddlers on click of btn2(Toddlers)
                $("#specify_image").attr("src", "img/a1.jpg");
                // Change text for Toddlers on click of btn2(Toddlers)
            ...
            $("#btn3").click(function(){
                // Change image for Preschoolers on click of btn3(Preschoolers)
                $("#specify_image").attr("src","img/a2.jpg");
                // Change text for Preschoolers on click of btn3(Preschoolers)
    ...
    <script type="text/javascript">
        function viewFAQ() {
            ...
            if (b=="1"){
                // Change image for FAQ on click of btn5(FAQ)
                $("#specify_image").attr("src","img/new.jpg");
                // Change text for FAQ on click of btn5(FAQ)
        ...
        function viewTC() {
            var b = document.getElementById("btn6").value;
            //scroll up code for next 2 lines
            document.body.scrollTop = 0; // For Safari
            document.documentElement.scrollTop = 0; // For Chrome, Firefox, IE and Opera
            if (b=="1"){
                // Change image for T&C on click of btn6(T&C)
                $("#specify_image").attr("src","img/sc.jpg");
                // Change text for T&C on click of btn6(T&C)
